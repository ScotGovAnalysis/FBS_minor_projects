...
source('FBS cf census.R')
rmarkdown::render('FBS_cf_census.Rmd', output_file = paste0(output_file_title,".html"))
rmarkdown::render('FBS_cf_census_with_BRN.Rmd', output_file = paste0(output_file_title," with BRNs.html"))
